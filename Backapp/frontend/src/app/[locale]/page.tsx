...
export default function HomePage({ params }: HomePageProps) {
  ...
  return (
    ...
    <div className="relative w-full max-w-[1920px] h-[10700px] bg-[#17101E] mx-auto overflow-hidden">
      ...
      <div className="absolute left-[114px] top-[3750px] w-[1681px] h-[787px]">
        {/* Заголовок */}
        <div className="absolute left-0 top-0 w-[561px] h-[94px]">
          <div className="absolute left-0 top-0 w-[561px] h-[65px]">
            <h2 className="text-white text-[20px] leading-[24.2px] font-inter font-normal uppercase">Сотрудничества</h2>
          </div>
          <div className="absolute left-0 top-[36px] w-[547px] h-[58px]">
            <h1 className="text-white text-[40px] leading-[45.4px] font-franklin font-normal uppercase">Наши парёнры и друзья</h1>
          </div>
          <div className="absolute left-[2px] top-[27.5px] w-[190px] h-[1px] bg-white"></div>
        </div>

        {/* Левая картинка */}
        <div className="absolute left-0 top-[157px] w-[796px] h-[347px] rounded-[23px] overflow-hidden">
          <Image
        ...
        <div className="absolute left-[885px] top-[157px] w-[796px] h-[347px] border border-[#0F74EB] rounded-[23px] p-[28px] bg-[rgba(25,21,52,0.3)]">
          <div className="space-y-[20px]">
            <div className="flex gap-[20px] text-[12px] font-inter font-bold text-white">
              <span>Категория:</span>
              <span>IT сервис</span>
            </div>
            <div className="flex gap-[20px] text-[12px] font-inter font-bold text-white">
              <span>Название:</span>
              <span className="text-[20px] text-[#3B82F6]">SELLER TOP</span>
            </div>
            <div className="text-[12px] font-inter font-bold text-white">
              Описание:
            </div>
            <p className="text-white text-[20px] font-inter font-normal">
              Наша платформа помогает селлерам - помогаем селлерам и предпринимателям расти, масштабироваться и уверенно выходить на новые рынки. Каждое направление — это шаг к устойчивому и прибыльному бизнесу. Выберите интересующий блок, чтобы узнать, как мы можем быть полезны.
            </p>
          </div>
        </div>

        {/* Слайдер логотипов */}
        <div className="absolute left-0 top-[543px] w-[1681px] h-[244px]">
          <div className="flex items-center justify-center h-full">
            <div className="w-[517px] h-[244px] bg-white rounded-[16px] flex items-center justify-center">
              <span className="text-black text-[20px] font-inter">Логотипы партнёров</span>
            </div>
          </div>
        </div>

        {/* Кнопки навигации и "Все партнёры" */}
        <Link 
          href={`/${locale}/partners`}
          className="group absolute left-[1191px] top-[45px] w-[343px] h-[54px] bg-gradient-to-r from-[#0283F7] to-[#850191] rounded-[8px] flex items-center justify-center relative overflow-hidden hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/25 transition-all duration-300"
        >
          {/* Градиентный overlay */}
          <div className="absolute inset-0 bg-gradient-to-r from-[#0396FF] to-[#9D05A8] opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          ...
          <span className="relative z-10 text-white text-[20px] font-inter font-semibold group-hover:text-shadow-lg transition-all duration-300">Все партнёры</span>
          <span className="relative z-10 text-white ml-2 group-hover:translate-x-1 transition-transform duration-300">→</span>
        </Link>
      </div>
